...
const (
	TrackingService_UpdateTracking_FullMethodName = "/tracking.TrackingService/UpdateTracking"
...
type TrackingServiceClient interface {
	UpdateTracking(ctx context.Context, in *UpdateTrackingRequest, opts ...grpc.CallOption) (*UpdateTrackingResponse, error)
...
func (c *trackingServiceClient) UpdateTracking(ctx context.Context, in *UpdateTrackingRequest, opts ...grpc.CallOption) (*UpdateTrackingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateTrackingResponse)
	err := c.cc.Invoke(ctx, TrackingService_UpdateTracking_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTrackingServiceServer) UpdateTracking(context.Context, *UpdateTrackingRequest) (*UpdateTrackingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateTracking not implemented")
}
...
func _TrackingService_UpdateTracking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTrackingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrackingServiceServer).UpdateTracking(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TrackingService_UpdateTracking_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrackingServiceServer).UpdateTracking(ctx, req.(*UpdateTrackingRequest))
	}
...
var TrackingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UpdateTracking",
			Handler:    _TrackingService_UpdateTracking_Handler,
		},
		{
	...
	Metadata: "internal/proto/tracking.proto",
}
